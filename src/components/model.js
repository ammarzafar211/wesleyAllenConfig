        ...
        if (textureValue) {
          if (node.name.includes("fabric") || node.name.includes("Fabric")) {
            ...
            if (textureValue.length > 4) {
              ...
              // const mapF = loadTexture("./Golden Bisque/Base_color.png");
              ...
              //   "./Golden Bisque/base_Metalness.png"
              // );
              ...
              // const normalMapF = loadTexture("./Golden Bisque/base_Normal.png");
              ...
              //   "./Golden Bisque/base_Roughness.png"
              // );
